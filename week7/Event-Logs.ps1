. (Join-Path $PSScriptRoot "..\week6\Local User Manage Menu\String-Helper.ps1")
...
function atRiskUsers($days) {
        ...
        return ($userLogins | Group-Object "User" | Where-Object { $_.Count -gt 10} | Select-Object Count, Name  | Format-Table | Out-String)
}